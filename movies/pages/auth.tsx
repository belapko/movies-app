...
const Auth = () => {
    ...
    return (
        <div className="relative h-full w-full bg-[url('../public/images/netflixteaser.png')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-black h-full w-full sm:bg-opacity-50">
                <nav className='px-12 py-5'>
                    <img src="/images/logo.png" alt="Logo" className='h-12'/>
                </nav>
                <div className='flex justify-center'>
                    <div className="bg-black bg-opacity-70 px-16 py-16 self-center mt-2 md:w-3/5 lg:w-2/5 lg:max-w-md md:max-w-sm rounded-md w-full">
